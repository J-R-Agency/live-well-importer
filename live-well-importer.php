...
/*				    echo "<pre>";
					...
					foreach( $service as $item ){ 
						...
						print_r( $item["Name"] . " <br> " . implode(",",implode(",",$item["Locations"])) . " <br> " . implode(",",implode(",",$item["Logo"])) . " <br> " . implode(",",implode(",",$item["AdditionalInformationFields"]))  . " <br> " . $item["WebsiteUrl"] . " // " . $item["Organisation"] . " <br> " . " <br> " );
